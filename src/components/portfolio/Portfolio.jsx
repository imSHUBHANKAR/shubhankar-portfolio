...
const Portfolio = () => {
    ...
    {
      image: Figma8,
      title: 'Dashboard in React using Tailwind CSS',
      figmaLink: 'https://www.figma.com/design/v3NUjY8xx7yf9LXCJrBXSg/Dashboard?node-id=0-1&t=370mWoktDeV4gex0-1',
      demoLink: 'https://www.figma.com/design/v3NUjY8xx7yf9LXCJrBXSg/Dashboard?node-id=0-1&t=370mWoktDeV4gex0-1',
    },
    {
      image: Figma7,
      title: 'Finance Website (React.js)',
      figmaLink: 'https://www.figma.com/design/i7rd86qLNPTp2VHakVQ4zq/Finstreet?node-id=0-1&t=2G5DuJRXi0nDYpFQ-1',
      demoLink: 'https://shubh-finance-website.vercel.app/',
    },
    {
      image: Figma6,
    ...
    {
      image: Figma5,
      title: 'Blog Website using HTML/CSS/JavaScript',
      figmaLink: 'https://github.com',
      demoLink: 'https://dribbble.com/',
    },
    {
      image: Figma4,
      title: 'E-commerce Website Design (UI/UX)',
      figmaLink: 'https://www.figma.com/file/UGNe73X4aoAL3MddMDgqFn/LoginPage?type=design&node-id=0%3A1&mode=design&t=yAXG8UdM1UyScpdT-1',
      demoLink: 'https://www.figma.com/proto/UGNe73X4aoAL3MddMDgqFn/LoginPage?type=design&node-id=2-10&t=3cJmxk7dZh3E9jjh-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=2%3A10&mode=design',
    },
    {
      image: Figma3,
      title: 'Music App System (UI/UX)',
      figmaLink: 'https://www.figma.com/file/o1k8g3s7w0D6iI4Qq3DnCV/MusicPlayer?type=design&node-id=0%3A1&mode=design&t=RXsiEoiMmu1q256Y-1',
      demoLink: 'https://www.figma.com/proto/o1k8g3s7w0D6iI4Qq3DnCV/MusicPlayer?type=design&node-id=20-7&t=Fr9s2ZJmgiefChGG-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=20%3A7&mode=design',
    },
    {
      image: Figma2,
      title: 'Debit/Credit Card Based on QR Code (UI/UX)',
      figmaLink: 'https://www.figma.com/file/fbVUAiqoD1S3mWVKUZRJZE/Debit%2FCredit-Card?type=design&node-id=0%3A1&mode=design&t=PXhu27ET2FbhV6Yn-1',
      demoLink: 'https://www.figma.com/proto/fbVUAiqoD1S3mWVKUZRJZE/Debit%2FCredit-Card?type=design&node-id=10-64&t=PXhu27ET2FbhV6Yn-0&scaling=scale-down&page-id=0%3A1&starting-point-node-id=10%3A64',
    },
    {
      image: Figma1,
      title: 'Academic Website (UI/UX)',
      figmaLink: 'https://www.figma.com/file/JVu5UEOl84C2g6uPI2Ubsr/CforCoding?type=design&node-id=0%3A1&mode=design&t=rA92nz6Zuo0N8iHr-1',
      demoLink: 'https://www.figma.com/proto/JVu5UEOl84C2g6uPI2Ubsr/CforCoding?type=design&node-id=21-426&t=rA92nz6Zuo0N8iHr-0&scaling=scale-down&page-id=0%3A1&starting-point-node-id=21%3A426',
    },
      ...
      <div className='container portfolio__container'>
        {projects.map((project, index) => (
          <article key={index} className='portfolio__item'>
            ...
            <h3>{project.title}</h3>
            <div className="portfolio__item-cts">
              <a href={project.figmaLink} className='btn' target='_blank' rel="noopener noreferrer">Figma</a>
              <a href={project.demoLink} className='btn btn-primary' target='_blank' rel="noopener noreferrer">
                Live Demo <FcBinoculars />
              </a>
            </div>
          </article>
        ))}
